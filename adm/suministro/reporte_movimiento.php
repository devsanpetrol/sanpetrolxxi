...
<head>
    ...
    <title><?php include '../../bar_nav/title.php'; ?> - Reporte de Movimientos de Equipos </title>
    ...
    <script src="js/engineJS_25.js"></script>
	...
	<!-- /COL-MD-10 TABLA CONTENIDO -->
            <div class="card">
                <div class="card-header">
                    <div class="row">
                    <div class="col-md-9">
                        <h3>REPORTE DE MOVIMIENTO Y TRAZABILIDAD</h3>
                    </div>
                    <div class="col-md-3 text-right">
                        <div class="form-group">
                            <button type="button" class="btn btn-primary daterange-ranges fecha-rango">
