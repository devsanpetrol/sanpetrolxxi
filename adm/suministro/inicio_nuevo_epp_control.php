...
<head>
    ...
    <script src="js/engineJS_20.js"></script>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center mb-3 py-2">
                                    <h4 class="font-weight-semibold mb-1">Control de entregas de Equipo de Protección Personal (EPP) 
                                        <a href="#" class="btn bg-transparent text-danger btn-icon mr-3 legitRipple">
                                            <i class="icon-notebook icon-2x"></i>
					</a>
                                    </h4>
                                </div>
