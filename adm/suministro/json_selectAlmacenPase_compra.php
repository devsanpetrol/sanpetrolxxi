<?php
    ...
    $categorias = $suministro->get_almacen_salida_compra("WHERE adm_view_almacen_salida_compra.id_pedido = ".$id_pedido);
    $data = array();
    ...
    foreach ($categorias as $valor) {
        $data[] = array("fecha_solicitud" => fecha($valor['folio'],date('d M h:i a', strtotime($valor['fecha_solicitud'])),date('d M', strtotime($valor['fecha_requerimiento'])),$valor['id_pedido']),
                        ...
                        "cantidad_surtir" => cantidad_surtir($valor['id_pedido'],$valor['cod_articulo'],$valor['cantidad_compra']),
