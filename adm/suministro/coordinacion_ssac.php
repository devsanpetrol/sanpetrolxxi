	...
	<div class="page-content">
		...
		<div class="content-wrapper">
                    ...
                    <div class="page-header page-header-light">
                        <div class="page-header-content header-elements-md-inline">
                            <div class="page-title d-flex">
                                <h4><i class="icon-drawer3 mr-2"></i> <span class="font-weight-semibold">COORDINACIÓN DE SEGURIDAD, SALUD, AMBIENTE Y CALIDAD</span></h4>
				...
				<div class="d-flex align-items-start flex-column flex-md-row">
                                    <div class="w-100 order-2 order-md-1">
                                        ...
                                        <div class="card" id="tabla_visor_solicitudes">
                                            <div class="table-responsive" id="content_table_pedidos_list" data-scroll="">
                                                <table class="table table-xs " id="lay_out_solicitudesx" cellspacing="0" width="100%" data-idcoordinacion="7">
                                                    <col width="20%">
                                                    <col width="5%">
                                                    <col width="5%">
                                                    <col width="50%">
                            ...
                            <!-- /inner container -->
                    <!-- /large modal -->
                    <div id="mod_log_acces" class="modal fade" tabindex="-1" data-firmax="7" style="display: none;">
